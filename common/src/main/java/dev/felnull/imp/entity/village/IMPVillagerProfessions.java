...
public class IMPVillagerProfessions {
    ...
    public static void init() {
        ...
        TradeRegistry.registerVillagerTrade(DJ, 5, OERegistryUtil.createTradeItemsForEmeralds(new ItemStack(IMPItems.ANTENNA), 25, 1, 1, 23));
        TradeRegistry.registerVillagerTrade(DJ, 5, OERegistryUtil.createTradeItemsForEmeralds(new ItemStack(IMPItems.PARABOLIC_ANTENNA), 45, 1, 1, 23));
