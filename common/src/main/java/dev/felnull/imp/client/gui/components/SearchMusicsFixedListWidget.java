...
public class SearchMusicsFixedListWidget extends IMPBaseFixedListWidget<MusicMediaResult> {
    ...
    @Override
    protected void renderOneButton(PoseStack poseStack, MusicMediaResult item, int lnum, int bnum, int bX, int bY, int mx, int my, float parTick, boolean selected) {
        ...
        drawSmartFixedWidthText(poseStack, Component.literal(item.author()), bX + sx, bY + 12, getIndividualWidth() - sx - 2);
    }
}
