...
public class WritePlayListFixedButtonsList extends PlayListFixedButtonsList {
    ...
    public WritePlayListFixedButtonsList(int x, int y, List<MusicPlayList> list, PressEntry<MusicPlayList> onPressEntry, Function<MusicPlayList, Boolean> selected) {
        super(x, y, 68, 42, 6, Component.translatable("imp.fixedList.myPlaylist"), list, onPressEntry);
