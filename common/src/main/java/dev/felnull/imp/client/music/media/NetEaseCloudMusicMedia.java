...
public class NetEaseCloudMusicMedia implements MusicMedia {
    private static final Component MEDIA_NAME = new TranslatableComponent("imp.loaderType.neteasecloudmusic");
    private static final Component NECM_ENTER_TEXT = new TranslatableComponent("imp.text.enterText.neteasecloudmusic");
    ...
    private MusicMediaResult createResult(JsonObject songJson, String songId, long duration) {
        ...
        return new MusicMediaResult(new MusicSource("netease_cloud_music", songId, duration), ImageInfo.EMPTY, naa.getLeft(), String.join(", ", naa.getRight()));
    }
}
