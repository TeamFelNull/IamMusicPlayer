...
public class IMPBlocks {
    ...
    public static final Block BOOMBOX = register("boombox", new BoomboxBlock(BlockBehaviour.Properties.of(Material.METAL).sound(SoundType.LANTERN).requiresCorrectToolForDrops().strength(3.0F)));
