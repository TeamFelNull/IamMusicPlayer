...
public class DebugMonitor extends MSDBaseMonitor {
    public final List<String> goToScreen = new ArrayList<>();

    public DebugMonitor(MusicSharingDeviceBlockEntity.Screen msdScreen, MusicSharingDeviceScreen parentScreen, int x, int y, int width, int height) {
