...
import red.felnull.imp.client.gui.widget.GuildPlayListScrollButton;
...
public class MusicSharingDeviceScreen extends AbstractIkisugiContainerScreen<MusicSharingDeviceContainer> {
    ...
    public void insMode(Monitors moniter) {
        ...
        if (!isSlectedMonitor(moniter, Monitors.CREATEPLAYLIST, Monitors.ADDPLAYMUSIC1, Monitors.ADDPLAYMUSIC2)) {
            if (picturImage != null) {
                picturImage = null;
