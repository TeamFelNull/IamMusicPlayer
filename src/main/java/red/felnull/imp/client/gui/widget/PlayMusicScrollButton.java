...
public class PlayMusicScrollButton extends ScrollListButton {
    ...
    public PlayMusicScrollButton(int x, int y, int sizeX, int sizeY, int sizeOne, ScrollBarSlider scrollBar, IPressable pressed, IMusicPlayListScreen sc, MusicSharingDeviceScreen msds, boolean mini) {
