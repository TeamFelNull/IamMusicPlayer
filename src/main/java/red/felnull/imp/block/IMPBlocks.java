...
public class IMPBlocks {
    ...
    public static final Block TEST_BLOCK = register("test", new Block(AbstractBlock.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(1.5f, 1f)));
