...
import red.felnull.imp.item.BoomBoxItem;
import red.felnull.imp.item.IMPItemGroup;
import red.felnull.imp.item.WallOrFloorStateBlockItem;

public class IMPBlocks {
    public static final Block BOOMBOX = new BoomboxBlock(Block.Properties.create(Material.IRON)
            .sound(SoundType.LANTERN).hardnessAndResistance(1f, 0.5f).notSolid()).setRegistryName(
    ...
    public static final Block SOUNDFILE_UPLOADER = new SoundfileUploaderBlock(Block.Properties.create(Material.IRON)
            .sound(SoundType.METAL).hardnessAndResistance(1f, 0.5f).notSolid()).setRegistryName(
